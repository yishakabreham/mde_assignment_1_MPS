...
/*package*/ class Company_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Codic Fiscale: ");
    editorCell.setCellId("Constant_f9uj87_c0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.TEXT_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_f9uj87_a0c0()));
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
  private Color _StyleParameter_QueryFunction_f9uj87_a0c0() {
    if (SPropertyOperations.getString(getNode(), PROPS.codice$GILA).length() < 13 || SPropertyOperations.getString(getNode(), PROPS.codice$GILA).length() > 13) {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.codice$GILA;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new addressSingleRoleHandler_f9uj87_f0(myNode, LINKS.address$Aaiq, getEditorContext());
  ...
  private static class addressSingleRoleHandler_f9uj87_f0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.address$Aaiq, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.address$Aaiq, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.address$Aaiq);
      }
      Style style = new StyleImpl();
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.address$Aaiq));
      try {
  ...
  private static class transactionsListHandler_f9uj87_j0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.transactions$xIKb;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Transaction$nO;
    }
